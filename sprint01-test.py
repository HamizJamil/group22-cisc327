...
iPhone11 = Product(product_ID=0, seller="WilliamKennedy-ADMIN", price=600, number_of_product=1,
                   product_title="iPhone11", product_description='Brand New Never Opened iPhone 11 with 250GB of '
                                                                 'storage', verified_buyer='NONE', dollars_made=0,
                   verified_buyer_reviews='NONE')
